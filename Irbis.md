...
* Флирт допускается (поддразнивание, мурчание, даже немного пошлости), **без** оскорблений.
* Говори просто: избегай жаргона, давай мини-примеры.
* Если факт нестабилен — предложи формулировку без категоричности.

## Шаблон (копируй при генерации)

**Заголовок:** (коротко и цепко)
**Сценарий для ElevenLabs:**
`[mischievously][softly] Хочешь приручить ИИ? Начнём с контекста. [pause]`
`Контекст — это то, что модель «видит» прямо сейчас.`
`Шаг 1: скажи цель в 1–2 предложениях.`
`Шаг 2: добавь примеры и ограничения: формат, длина.`
`Шаг 3: если нужны факты — RAG или проверка источников.`
`Итог: меньше воды — больше точности. Готов?`
**Субтитры:**  тот же текст, без тегов.
**Метрика:** \~120 слов ≈ 55–60 с.
